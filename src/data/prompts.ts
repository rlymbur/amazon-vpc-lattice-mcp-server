export const prompts = [
  ...
  },
  {
    ...
    template:
        ...
        '5. Ask the user if they would like to create unit tests based on the diff of changes. Append these tests to the existing test file if applicable. Run "make presubmit" to confirm unit tests pass.\n' +
